...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        /*
         * [shohinListの値をshopMapのキーにしている。例えば40行目であればSHOP_SHOHIN_00のバナナがキーとなり、
         * それに対応するバリューは125となる。]
         *
         */
        ...
        for(String shohinSetsumei : shohinList) {
        	System.out.println(shohinSetsumei + "=" + shopMap.get(shohinSetsumei) +"円になります!");
        }
